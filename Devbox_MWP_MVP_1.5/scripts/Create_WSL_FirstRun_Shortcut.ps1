...
$ShortcutName = "Set up WSL & Ubuntu (One-Time).lnk"
$ShortcutPath = Join-Path $DesktopPath $ShortcutName

# Full path to the orchestrator script
$OrchestratorScript = "C:\ProgramData\Microsoft\DevBoxAgent\ImageDefinitions\devbox_mwp_mvp_1.1\win11-24h2-ent-m365-wsl2-ubuntu\scripts\Install_WSL_Ubuntu_FirstRun.ps1"
